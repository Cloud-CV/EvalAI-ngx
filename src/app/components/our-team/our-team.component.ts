  ...
  fetchOurTeamMembers() {
    ...
    SELF.apiService.getUrl(API_PATH).subscribe(
      data => {
      	...
      	if (results.length === 0) {
      		...
      		results = [  
			   {  
			      ...
			      'background_image': 'https://evalai.s3.amazonaws.com/media/bg-images/15775051_1334147123295477_4609249739680158814_o.jpg',
			   ...
			   {  
			      ...
			      'background_image': 'https://evalai.s3.amazonaws.com/media/bg-images/1965514_10152523766307739_2542282903877038889_o.jpg',
			   ...
			   {  
			      ...
			      'background_image': 'https://evalai.s3.amazonaws.com/media/bg-images/10178044_664063280345448_7169289118796237_n.jpg',
			   ...
			   {  
			      ...
			      'background_image': 'https://evalai.s3.amazonaws.com/media/bg-images/18056475_1816935868332485_6070888708209307482_o.jpg',
			   ...
			   {  
			      ...
			      'headshot': 'https://evalai.s3.amazonaws.com/media/headshots/AAEAAQAAAAAAAAfFAAAAJDdjZTQ5MThmLTJlOTMtNGMxMS05NTFjLTI3NmZiMTA0ZDE3OQ.jpg',
			      'background_image': 'https://evalai.s3.amazonaws.com/media/bg-images/13227264_948001968631519_3882689880500687242_o.jpg',
			   ...
			   {  
			      ...
			      'background_image': 'https://evalai.s3.amazonaws.com/media/bg-images/12362825_836486476462466_3609928140833176026_o.jpg',
			   ...
			   {  
			      ...
			      'background_image': 'https://evalai.s3.amazonaws.com/media/bg-images/15965604_10101311300574979_1155748140016787470_n.jpg',
			      'github_url': 'null',
			   ...
			   {  
			      ...
			      'background_image': 'https://evalai.s3.amazonaws.com/media/bg-images/12370908_10100934153600539_2116221676470914938_o.jpg',
        ...
        if (results.length !== 0) {
            let coreTeamList = [];
            let contributingTeamList = [];
            for (let i = 0; i < results.length; i++) {
                if (results[i].team_type === 'Core Team') {
                    SELF.coreTeamType = results[i].team_type;
                    SELF.coreTeamList = coreTeamList.push(results[i]);

                } else if (results[i].team_type === 'Contributor') {
                    SELF.contributingTeamType = results[i].team_type;
                    SELF.contributingTeamList = contributingTeamList.push(results[i]);
                }
                SELF.coreTeamDetails = coreTeamList;
                SELF.contributingTeamDetails = contributingTeamList;
            }
        } else {
