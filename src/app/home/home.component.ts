  ...
  const a = document.getElementsByClassName('testimonial_body')[0];
  const b = document.getElementsByClassName('testimonial_author')[0];
  const c = document.getElementsByClassName('testimonial_quotes')[0];
  if (direction === 'left') {
