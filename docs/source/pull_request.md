...
1. Fork the EvalAI repository from [the repository](https://github.com/Cloud-CV/EvalAI-ngx.git).
...
Once you have completed the above steps, you have successfully created a Pull Request to EvalAI-ngx.
